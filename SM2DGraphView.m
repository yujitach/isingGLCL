...
static NSString *_sm_local_getSymbolForEnum( SM2DGraphSymbolTypeEnum inValue )
{
    ...
    case kSM2DGraph_Symbol_Triangle:
		result = [ NSString stringWithFormat:@"%C", (unsigned short)kUnicode_WhiteUpTriangle ];
        break;
    case kSM2DGraph_Symbol_Diamond:
		result = [ NSString stringWithFormat:@"%C", (unsigned short)kUnicode_WhiteDiamond ];
        break;
    case kSM2DGraph_Symbol_Circle:
		result = [ NSString stringWithFormat:@"%C", (unsigned short)kUnicode_WhiteCircle ];
        break;
    ...
    case kSM2DGraph_Symbol_FilledCircle:
		result = [ NSString stringWithFormat:@"%C", (unsigned short)kUnicode_BlackCircle ];
        break;
    case kSM2DGraph_Symbol_Square:
		result = [ NSString stringWithFormat:@"%C", (unsigned short)kUnicode_WhiteSquare ];
        break;
    case kSM2DGraph_Symbol_Star:
		result = [ NSString stringWithFormat:@"%C", (unsigned short)kUnicode_WhiteStar ];
        break;
    case kSM2DGraph_Symbol_InvertedTriangle:
		result = [ NSString stringWithFormat:@"%C", (unsigned short)kUnicode_WhiteDownTriangle ];
        break;
    case kSM2DGraph_Symbol_FilledSquare:
		result = [ NSString stringWithFormat:@"%C", (unsigned short)kUnicode_BlackSquare ];
        break;
    case kSM2DGraph_Symbol_FilledTriangle:
		result = [ NSString stringWithFormat:@"%C", (unsigned short)kUnicode_BlackUpTriangle ];
        break;
    case kSM2DGraph_Symbol_FilledDiamond:
		result = [ NSString stringWithFormat:@"%C", (unsigned short)kUnicode_BlackDiamond ];
        break;
    case kSM2DGraph_Symbol_FilledInvertedTriangle:
		result = [ NSString stringWithFormat:@"%C", (unsigned short)kUnicode_BlackDownTriangle ];
        break;
	case kSM2DGraph_Symbol_FilledStar:
		result = [ NSString stringWithFormat:@"%C", (unsigned short)kUnicode_BlackStar ];
		break;
    }
